...
namespace ApiWorker.Migrations
{
    ...
    [Migration("20251118100349_DocumentSignaturesAndThemes")]
    partial class DocumentSignaturesAndThemes
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("ApiWorker.Documents.Entities.Document", b =>
                {
                    ...
                    b.Property<string>("AppliedThemeJson")
                        .HasColumnType("nvarchar(max)");
                    ...
                    b.Property<string>("SignatureBlobUrl")
                        .HasMaxLength(512)
                        .HasColumnType("nvarchar(512)");
            ...
            modelBuilder.Entity("ApiWorker.Documents.Entities.Document", b =>
                {
                    ...
                    b.HasOne("ApiWorker.Documents.Entities.Template", null)
                        .WithMany()
